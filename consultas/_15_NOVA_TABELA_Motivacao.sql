CREATE OR REPLACE TABLE
  transformed_files._15_NOVA_TABELA_Motivacao AS
SELECT
  Datadecadastro,
  Canaldeatendimento,
  Cenariodaviolacao,
  ...
  CASE
    WHEN `Motivacao` is null THEN 'NÃO INFORMADO'
    WHEN `Motivacao`= 'N/D' THEN 'NÃO INFORMADO'
  ...
  Pais_do_suspeito
FROM
  tcc-project-thais.transformed_files._14_NOVA_TABELA_sl_quantidade_vitimas