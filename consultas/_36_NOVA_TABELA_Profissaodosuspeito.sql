CREATE OR REPLACE TABLE
  transformed_files._36_NOVA_TABELA_Profissaodosuspeito AS
SELECT
  Datadecadastro,
  Canaldeatendimento,
  Cenariodaviolacao,
  ...
  UFdosuspeito,
  CASE
    WHEN `Profissaodosuspeito` IS NULL THEN 'NÃO INFORMADO'
    WHEN `Profissaodosuspeito` = 'N/D' THEN 'NÃO INFORMADO'
    WHEN `Profissaodosuspeito` = 'undefined' THEN 'NÃO INFORMADO'
  ELSE
  `Profissaodosuspeito`
END
  AS `Profissaodosuspeito`,
  ...
  Pais_do_suspeito
FROM
  tcc-project-thais.transformed_files._35_NOVA_TABELA_UFdosuspeito